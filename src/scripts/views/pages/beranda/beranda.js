...
const Beranda = {
  ...
  <section id="content-2" class="content-2">
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-6">
          <figure class="figure" data-aos="fade-right" data-aos-duration="7000">
            <img src=${image4} class="figure-img img-fluid rounded" alt="Ilustration AnimaCare">
          </figure>
        </div>
        <div class="col-md-6 d-flex flex-column justify-content-center" data-aos="fade-left" data-aos-duration="7000" data-aos-delay="500">
    ...
    <div class="container mt-5">
      <h3 class=" font-weight-bold" style = "margin-bottom:30px;">Belanja Keperluan <span style="color: #699BF7;">Hewan Kesayangan </span></h3>
        ...
        <div class="list-icon-belanja mx-auto">
          <button class="icon-belanja btn" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="50">
          ...
          <button class="icon-belanja btn" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
          ...
          <button class="icon-belanja btn" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="150">
            <img src="${iconParfum}" alt="Icon Parfum" width="100px" height="100px" class=" mx-auto d-block mt-2"/>
            <p class="mt-2 text-center">Parfum</p>
          </button>
          <button class="icon-belanja btn" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
