...
const Belanja = {
  ...
  async render() {
    ...
    return `
  <div class="container">
      <h3 class="title__header-belanja mt-5 font-weight-bold">Temukan produk yang dibutuhkan untuk <span style="color: #699BF7">Hewan Kesayanganmu!</span></h3>
      <section id="content-1" class="content-1 my-5">
        <div class="container">
          <div class="row">
            <div class="col-sm crd-rule">
              <img src="${logoTroli}" alt="Logo Troli" class="mx-auto d-block" width="200px" data-aos="fade-up" data-aos-duration="1000"/>
              <p class="text-center mt-3">Selamat berbelanja!, silahkan pilih kategori produk sesuai kebutuhan yang Anda inginkan</p>
            </div>
            <div class="col-sm crd-rule">
              <img src="${logoToko}" alt="Logo Toko" class="mx-auto d-block" width="200px" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="50"/>
            ...
            <div class="col-sm crd-rule">
              <img src="${logoTas}" alt="Logo Tas" class="mx-auto d-block" width="200px" data-aos="fade-up" data-aos-duration="1000"/>
      ...
      <section id="content-2" class="content-2-belanja">
        <div class="container content-2-belanja">
          <h3 class=" font-weight-bold mb-5">Kategori Pilihan</h3>
            <div class="list-icon-belanja mx-auto" id="containerCategory">
              <button class="icon-belanja btn" id="iconMakananKucing" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="50">
              ...
              <button class="icon-belanja btn" id="iconMakananAnjing" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="100">
              ...
              <button class="icon-belanja btn" id="iconParfum" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="150">
                <img src="${iconParfum}" alt="Icon Parfum" width="100px" height="100px" class=" mx-auto d-block mt-2"/>
                <p class="mt-2 text-center">Parfum</p>
              </button>
              <button class="icon-belanja btn" id="iconVitamin" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="200">
              ...
              <button class="icon-belanja btn" id="iconKandang" data-aos="flip-down" data-aos-duration="1000" data-aos-delay="50">
              ...
              <button class="icon-belanja btn" id="iconSusu" data-aos="flip-down" data-aos-duration="1000" data-aos-delay="100">
                <img src="${iconSusu}" alt="Icon Susu" width="70px" height="100px" class=" mx-auto d-block mt-2"/>
                <p class="mt-2 text-center">Susu</p>
              </button>
              <button class="icon-belanja btn" id="iconObat" data-aos="flip-down" data-aos-duration="1000" data-aos-delay="150">
                <img src="${iconObat}" alt="Icon Obat" width="100px" height="100px" class=" mx-auto d-block mt-2"/>
                <p class="mt-2 text-center">Obat</p>
              </button>
              <button class="icon-belanja btn" id="iconBoxPasir" data-aos="flip-down" data-aos-duration="1000" data-aos-delay="200">
              ...
              <button class="icon-belanja btn" id="iconPasir" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="50">
                <img src="${iconPasir}" alt="Icon Box Pasir" height="100px" width="100px" class=" mx-auto d-block mt-2"/>
                <p class="mt-2 text-center">Pasir</p>
              </button>
              <button class="icon-belanja btn" id="iconAksesoris" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="100">
              ...
              <button class="icon-belanja btn" id="iconSampo" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="150">
              ...
              <button class="icon-belanja btn" id="iconTasHewan" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="200">
